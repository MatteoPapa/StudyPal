                    ...
                    <div class="searchbar d-flex justify-content-center align-items-center py-4 col-12">
                            ...
                            <div class="searchform">
                                <form action="index.php" style="width:100%" class="d-flex col-12">
                                    ...
                                    <input type="text" class="form-control annuncisearch" placeholder="Ricerca username" style="border:0;">
                                </form>
                            </div>
                        ...
                        <button class="btn btn-success">
                            ...
                            <a href="annunciutility/write.php"><span class="mx-1" style="color:white">Scrivi un annuncio</span></a>
                        </button>
                    </div>
