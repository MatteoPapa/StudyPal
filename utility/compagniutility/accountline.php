...
<a class="profilerow" href="utility/compagniutility/compagni.user.php?user=<?=$searchUsername?>">
    <table style="font-size:large" class="tablerowhover widget-26 <?php
        ...
        <tbody>
            ...
            <tr class="tablerow">
                    <td class="tableavatar px-2 my-2" style="width:45px;">
                        <div class="widget-26-job-emp-img">
                            <img class="avatarsearch" src="<?php
                                if ($searchPicture!=""){
                                    echo ('media/profilepics/'.$searchPicture);
                                }
                                else if ($searchGenere=="femmina"){
                    ...
                    <td class="tablebio my-2">
                        <div class="biocontainer">
                            <p class="type px-2"><?php 
                                if ($searchBiografia!="") echo $searchBiografia;
                                else echo "Nessuna biografia";
                            ?></p>
                        </div>
                    </td>
                    <?php
                        //FORMATO BUONO PER BIOGRAFIA
                        $searchBiografia=str_replace("'","&#39",$searchBiografia);
                        $searchBiografia=json_encode($searchBiografia, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES);
                    ?>
                        <td class="tablebioicon">
                            <div id="chaticon" class="px-2">
                                <a href="javascript:void(0);" onclick='biografiaAppears(<?php echo $searchBiografia?>)'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="black" class="bi bi-chat-quote" viewBox="0 0 16 16">
